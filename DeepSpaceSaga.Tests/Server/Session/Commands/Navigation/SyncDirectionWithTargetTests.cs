...
{
    [Fact]
    public void SyncDirectionWithTargetCommand_WithExistTarget_ShouldWorkCorrectForIncreaseSpeed()
    {
        // Arrange
        ...
        Assert.Equal(calculationCycles, _gameServer.Metrics.Get(Metrics.ProcessingNavigationSyncDirectionWithTargetCommand));
    ...
    [Fact]
    public void SyncDirectionWithTargetCommand_WithExistTarget_ShouldWorkCorrectForDecreaseSpeed()
    {
        // Arrange
        double expectedReceivedCommand = 1;
    ...
    [Fact]
    public void SyncDirectionWithTargetCommand_WithoutExistTarget_ShouldWorkCorrect()
    {
        // Arrange
        double expectedReceivedCommand = 1;
    ...
    [Fact]
    public void SyncDirectionWithTargetCommand_WithMoreFasterTarget_ShouldWorkCorrect()
    {
        // Arrange
        double expectedReceivedCommand = 1;
